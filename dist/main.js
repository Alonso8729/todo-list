...
const dom = (() => {
    ...
    function changeMainTitle(target, index) {
        ...
        if (target.classList.contains('project-element')) {
            ...
            mainTitleText.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[index].title;
            document.title = `Todo List - ${mainTitleText.textContent}`;
        }
    ...
    function showTasks(menuCategory, projectIndexStart, projectIndexEnd) {
        const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'yyyy-MM-dd');
        let taskNumber = 0;
        ...
        for (let i = projectIndexStart; i < projectIndexEnd; i++) {
            for (let j = 0; j < _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[i].tasks.length; j++) {
                ...
                //Clicked on 'week' - Filter tasks which doesn't take place at the following week
                    ...
                    const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[i].tasks[j].date);
                    const dateOfToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todayDate);

                    if (!((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate, dateOfToday) <= 7 && (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(taskDate, dateOfToday) >= 0)) {
                        continue;
                    }
                }
                taskNumber++;
                ...
                //TASK COMPLETION
                if (_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[i].tasks[j].completed === false) {
    ...
    function getTasks(title, projectIndex) {
        ...
        if (title === 'project') {
            ...
            if (_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks.length === 0) {
                taskCounter.textContent = 0;
            }
        }
        //Clicked on menu link
            ...
            startProjectIndex = 0;
            endProjectIndex = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList.length;
        }
    ...
    function getInfo(projectIndex, taskIndex) {
        ...
        //ADD TITLE
        infoTitle.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].title;
        //ADD DESCRIPTION
        infoDescription.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].description;
        //ADD DATE
        infoDate.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].date;
        //ADD PRIORITY
        if (_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].priority === 'low')
            infoPriority.textContent = 'Low Priority';
        else if (_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].priority === 'medium')
            infoPriority.textContent = 'Medium Priority';
        else if (_projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].priority === 'high')
            infoPriority.textContent = 'High Priority';
        else
            infoPriority.textContent = '';
        //ADD PROJECT TITLE
        infoProject.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].title;
    }
        ...
        if (modalStatus === 'show') {
            ...
            if (modalFunction === 'add') {
                ...
                if (modalTitle === 'Delete Project') {
                    ...
                    strongProjectTitle.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].title;
                }
                else {
                    modalDeleteTaskText.classList.remove('hide');
                    strongTaskTitle.textContent = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].title;
                }
            }
                ...
                if (modalTitle === 'Edit Task') {
                    ...
                    formTitle.value = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].title;
                    taskDescription.value = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].description;
                    dueDate.value = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].date;
                    taskPriority.value = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].tasks[taskIndex].priority;
                }
                else {
                    const selectedLink = document.querySelector('.selected-link')
                    projectIndex = parseInt(selectedLink.getAttribute('data-link-index'), 10);
                    formInput.value = _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].projectsList[projectIndex].title;
                }
    ...
    function validateModal(action, projectIndex, taskIndex, currentLink) {
        ...
        if (!(form.classList.contains('hide')) && formTitle.value === "") {
            ...
            if ((modalTaskDiv.classList.contains('hide'))) {
                _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(formTitle.value);
            ...
            //ADD TASK
                ...
                _tasks_js__WEBPACK_IMPORTED_MODULE_1__["default"].addTask(formTitle.value, description, date, priority, projectIndex);
            }
        }
        else if (action === 'delete') {
            //DELETE PROJECT
            if (!(modalDeleteProjectText.classList.contains('hide'))) {
                _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(projectIndex);
                addTaskBtn.classList.add('hide');
                selectLink(allMenuLink, projectIndex);
            }
            //DELETE TASK
            else {
                _tasks_js__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTask(projectIndex, taskIndex);
            ...
            //EDIT PROJECT
            if (taskIndex === '') {
                _projects_js__WEBPACK_IMPORTED_MODULE_0__["default"].editProject(projectIndex, formTitle.value, currentLink);
            ...
            //EDIT TASK
                ...
                _tasks_js__WEBPACK_IMPORTED_MODULE_1__["default"].editTask(formTitle.value, description, date, priority, projectIndex, taskIndex, currentLink);
            }
        }
    }
...
const eventHandler = (() => {
    ...
    function clickListener() {
        ...
        document.addEventListener('click', (event) => {
            ...
            if (target.classList.contains('toggle-div') || target.getAttribute('id') === 'toggleButton') {
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].toggleMenu();
            }


            //Style selected link
            if (target.classList.contains('select')) {
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].selectLink(target, linkIndex);
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].changeMainTitle(target, linkIndex);
            }
            //Modal for adding project
            if (target.classList.contains('add-project-icon')) {
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Add Project', 'add');
            }
            //Modal for deleting and editing project
                ...
                if (target.classList.contains('fa-pen-to-square')) {
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Edit Project', 'edit', projectIndex);
                }
                //DELETE MODAL
                else if (target.classList.contains('fa-trash-can')) {
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Delete Project', 'delete', projectIndex);
                }
            }
            //ADDING TASK MODAL
            if (target.classList.contains('add-task-icon')) {
                ...
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Add Task', 'add', projectIndex, taskIndex);
            }
            ...
            if (target.classList.contains('task-icon')) {
                ...
                //EDIT TASK MODAL
                if (target.classList.contains('fa-pen-to-square')) {
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Edit Task', 'edit', projectIndex, taskIndex);
                }
                //DELETE TASK MODAL
                else if (target.classList.contains('fa-trash-can')) {
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Delete Task', 'delete', projectIndex, taskIndex);

                }
                //TASK INFO MODAL
                else if (target.classList.contains('fa-circle-info')) {
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('show', 'Task Info', 'info', projectIndex, taskIndex);
                }
            ...
            if (target.classList.contains('cancel-btn') || target.classList.contains('fa-xmark')) {
                _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].handleModal('close')
            }
            ...
            if (target.classList.contains('task-element')) {
                ...
                _tasks_js__WEBPACK_IMPORTED_MODULE_2__["default"].toggleCompletedTask(selectedLink, projectIndex, taskIndex)
            }
            //Validate Form
            if (target.classList.contains('confirm-btn')) {
                ...
                if (target.textContent === 'Add') {
                    projectIndex = parseInt(selectedLink.getAttribute('data-link-index'), 10);
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].validateModal('add', projectIndex, '', selectedLink);
                    _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks('project', projectIndex);
                }
                else if (target.textContent === 'Delete') {
                    //DELETE PROJECT
                    if (!(modalDeleteProjectText.classList.contains('hide'))) {
                        projectIndex = parseInt(selectedLink.getAttribute('data-link-index'), 10);
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].validateModal('delete', projectIndex, '', selectedLink);
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].showMainTitle(0);
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks('all');
                    }
                    //DELETE TASK
                    else {
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].validateModal('delete', projectIndex, taskIndex, selectedLink);
                    }
                }
                    ...
                    if (modalTaskDiv.classList.contains('hide')) {
                        projectIndex = parseInt(selectedLink.getAttribute('data-link-index'), 10);
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].validateModal('edit', projectIndex, "", selectedLink);
                    }
                    //EDIT TASK
                    else {
                        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].validateModal('edit', projectIndex, taskIndex, selectedLink);
                    }
                }
            }
        })
    ...
    function resizeWindow() {
        window.addEventListener('resize', _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].responsiveMenu);
    }
...
const projects = (() => {
    ...
    function editProject(index, title, link) {
        ...
        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].showProjects();
        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].selectLink(link, index, 'edit');
    }
...
const tasks = (() => {
    ...
    function addTask(title, description, date, priority, projectIndex) {
        ...
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks.push(task);
        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].showTasks();
    }

    function deleteTask(projectIndex, taskIndex) {
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks.splice(taskIndex, 1);
        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].showTasks('all');
    }

    function editTask(title, description, date, priority, projectIndex, taskIndex, selectedLink) {
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].title = title;
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].description = description;
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].date = date;
        _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].priority = priority;

        if (selectedLink.classList.contains('menu-element'))
            _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks(projectIndex);
        else
            _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks('project', projectIndex);
    }
    ...
    function toggleCompletedTask(selectedLink, projectIndex, taskIndex) {
        ...
        if (_projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].completed === true) {
            _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].completed = false
        }
        else {
            _projects_js__WEBPACK_IMPORTED_MODULE_1__["default"].projectsList[projectIndex].tasks[taskIndex].completed = true;
        }
        ...
        _dom_js__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks(currentLink, projectIndex);
    }
